...
def generator(words):
    ...
    if random.randint(1, 2) == 1:
        command = command + ' -gravity center ' + ' -fill blue '
    else:
    ...
    os.system(command)
    command = ' convert -blur 80 ' + saveName + ' ' + saveName
    #-blur 80x5
    os.system(command)
